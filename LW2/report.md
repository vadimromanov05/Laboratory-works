...
```
    7. Замечания автора:  использование команды git ssh-copy-id на ОС Windows оказалось невозможным. Возможно, для блага будущих поколений

следует ввести в лабораторную работу альтернативу этой команде для Windows
...
и я научился работать с удалённой машиной на ОС Unix. Кроме этого, меня ещё поразили многие команды, отработанные на этой ЛР. Пришлось также 

искать и новые источники информации, кроме Яндекс Практикума, что тоже можно вписать в список приобретённых знаний и навыков. В целом, если 

эта работа пройдёт защиту, то можно считать её не очень страшной и довольно интересной.